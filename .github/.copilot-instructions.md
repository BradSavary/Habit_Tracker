...
// WeeklyHabitCard & MonthlyHabitCard
const handleCardClick = (e: React.MouseEvent) => {
  if (e.detail === 2) { // Double-clic
    e.stopPropagation()
    onToggleComplete()
  } else if (e.detail === 1) { // Simple clic
    onOpen()
  }
}
```
...
- Feedback visuel immédiat (animation du checkmark)
...
- Loading Skeletons complets (base + composed + pages)
- Animations de confettis lors du level up